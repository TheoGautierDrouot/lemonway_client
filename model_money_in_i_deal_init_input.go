...
// MoneyInIDealInitInput struct for MoneyInIDealInitInput
type MoneyInIDealInitInput struct {
...
func (o MoneyInIDealInitInput) MarshalJSON() ([]byte, error) {
...
type NullableMoneyInIDealInitInput struct {
	value *MoneyInIDealInitInput
	isSet bool
}

func (v NullableMoneyInIDealInitInput) Get() *MoneyInIDealInitInput {
	return v.value
}

func (v *NullableMoneyInIDealInitInput) Set(val *MoneyInIDealInitInput) {
	v.value = val
	v.isSet = true
}

func (v NullableMoneyInIDealInitInput) IsSet() bool {
	return v.isSet
}

func (v *NullableMoneyInIDealInitInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMoneyInIDealInitInput(val *MoneyInIDealInitInput) *NullableMoneyInIDealInitInput {
	return &NullableMoneyInIDealInitInput{value: val, isSet: true}
}

func (v NullableMoneyInIDealInitInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMoneyInIDealInitInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
