...
// UpdateIndividualAccountDetailsInput struct for UpdateIndividualAccountDetailsInput
type UpdateIndividualAccountDetailsInput struct {
	// New Email.
...
func NewUpdateIndividualAccountDetailsInput() *UpdateIndividualAccountDetailsInput {
	this := UpdateIndividualAccountDetailsInput{}
	return &this
}
...
func (o UpdateIndividualAccountDetailsInput) MarshalJSON() ([]byte, error) {
...
type NullableUpdateIndividualAccountDetailsInput struct {
	value *UpdateIndividualAccountDetailsInput
	isSet bool
}

func (v NullableUpdateIndividualAccountDetailsInput) Get() *UpdateIndividualAccountDetailsInput {
	return v.value
}

func (v *NullableUpdateIndividualAccountDetailsInput) Set(val *UpdateIndividualAccountDetailsInput) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateIndividualAccountDetailsInput) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateIndividualAccountDetailsInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateIndividualAccountDetailsInput(val *UpdateIndividualAccountDetailsInput) *NullableUpdateIndividualAccountDetailsInput {
	return &NullableUpdateIndividualAccountDetailsInput{value: val, isSet: true}
}

func (v NullableUpdateIndividualAccountDetailsInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateIndividualAccountDetailsInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
